...
mysql -u root -proot -Bse "USE test; CREATE TABLE Time (id int NOT NULL PRIMARY KEY AUTO_INCREMENT,User VARCHAR(20),ChargeCode VARCHAR(20),TimeClocked TIME ,ClockType VARCHAR(20),Latest bool DEFAULT '0');"
...
mysql -u root -proot -Bse "USE test; INSERT INTO Time VALUES (NULL, 'ssebs','chg-regular', '2018-2-26 08:45:00', 'IN', FALSE);"
mysql -u root -proot -Bse "USE test; INSERT INTO Time VALUES (NULL, 'ssebs','chg-regular', '2018-2-26 16:45:00', 'OUT', TRUE);"
